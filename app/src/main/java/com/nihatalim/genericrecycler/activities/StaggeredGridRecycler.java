...
public class StaggeredGridRecycler extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_staggeredgridrecycler);

        this.recyclerView = findViewById(R.id.recycler_view);
        this.dateFormat = new SimpleDateFormat("dd/MM/yyyy");
        this.setUpUsers();

        adapter = new GenericRecycleAdapter<>(new ArrayList<User>(userList), getContext(), R.layout.user_card_grid);
